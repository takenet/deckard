...
type GetByIdResponse struct {
	...
	HumanReadablePayload map[string]string `protobuf:"bytes,3,rep,name=human_readable_payload,json=humanReadablePayload,proto3" json:"human_readable_payload,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
type Message struct {
	...
	Payload map[string]*any1.Any `protobuf:"bytes,8,rep,name=payload,proto3" json:"payload,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
type AddMessage struct {
	...
	Id string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	// A payload map with formatted data to be stored and used by clients.
	Payload map[string]*any1.Any `protobuf:"bytes,10,rep,name=payload,proto3" json:"payload,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
const file_deckard_service_proto_rawDesc = "" +
	"\n" +
	"\x15deckard_service.proto\x12\x0eblipai.deckard\x1a\x19google/protobuf/any.proto\"6\n" +
	"\x0eGetByIdRequest\x12\x14\n" +
	"\x05queue\x18\x01 \x01(\tR\x05queue\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\"\x94\x02\n" +
	"\x0fGetByIdResponse\x121\n" +
	"\amessage\x18\x01 \x01(\v2\x17.blipai.deckard.MessageR\amessage\x12o\n" +
	"\x16human_readable_payload\x18\x03 \x03(\v29.blipai.deckard.GetByIdResponse.HumanReadablePayloadEntryR\x14humanReadablePayload\x12\x14\n" +
	"\x05found\x18\x02 \x01(\bR\x05found\x1aG\n" +
	"\x19HumanReadablePayloadEntry\x12\x10\n" +
	...
	"\fcacheRemoved\x18\x01 \x01(\x03R\fcacheRemoved\x12&\n" +
	"\x0estorageRemoved\x18\x02 \x01(\x03R\x0estorageRemoved\"\xc4\x01\n" +
	"\vPullRequest\x12\x14\n" +
	"\x05queue\x18\x01 \x01(\tR\x05queue\x12\x16\n" +
	"\x06amount\x18\x02 \x01(\x05R\x06amount\x12%\n" +
	"\fscore_filter\x18\x03 \x01(\x03B\x02\x18\x01R\vscoreFilter\x12\x1b\n" +
	"\tmax_score\x18\x04 \x01(\x01R\bmaxScore\x12\x1b\n" +
	"\tmin_score\x18\x05 \x01(\x01R\bminScore\x12&\n" +
	"\x0fack_deadline_ms\x18\x06 \x01(\x03R\rackDeadlineMs\"C\n" +
	"\fPullResponse\x123\n" +
	"\bmessages\x18\x01 \x03(\v2\x17.blipai.deckard.MessageR\bmessages\"\x86\x04\n" +
	"\aMessage\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12\x14\n" +
	"\x05queue\x18\x03 \x01(\tR\x05queue\x12>\n" +
	"\apayload\x18\b \x03(\v2$.blipai.deckard.Message.PayloadEntryR\apayload\x12A\n" +
	"\bmetadata\x18\x04 \x03(\v2%.blipai.deckard.Message.MetadataEntryR\bmetadata\x12%\n" +
	"\x0estring_payload\x18\x05 \x01(\tR\rstringPayload\x12\x14\n" +
	"\x05score\x18\x06 \x01(\x01R\x05score\x12\x1e\n" +
	"\n" +
	"breakpoint\x18\a \x01(\tR\n" +
	"breakpoint\x12D\n" +
	"\vdiagnostics\x18\t \x01(\v2\".blipai.deckard.MessageDiagnosticsR\vdiagnostics\x1aP\n" +
	...
	"\x12MessageDiagnostics\x12\x12\n" +
	"\x04acks\x18\x01 \x01(\x03R\x04acks\x12\x14\n" +
	"\x05nacks\x18\x02 \x01(\x03R\x05nacks\x12)\n" +
	"\x10consecutive_acks\x18\x03 \x01(\x03R\x0fconsecutiveAcks\x12+\n" +
	"\x11consecutive_nacks\x18\x04 \x01(\x03R\x10consecutiveNacks\"*\n" +
	"\fCountRequest\x12\x14\n" +
	"\x05queue\x18\x01 \x01(\tR\x05queueJ\x04\b\x02\x10\x03\"%\n" +
	"\rCountResponse\x12\x14\n" +
	"\x05count\x18\x01 \x01(\x03R\x05count\"D\n" +
	"\n" +
	"AddRequest\x126\n" +
	"\bmessages\x18\x01 \x03(\v2\x1a.blipai.deckard.AddMessageR\bmessages\"\xf8\x03\n" +
	"\n" +
	"AddMessage\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12A\n" +
	"\apayload\x18\n" +
	" \x03(\v2'.blipai.deckard.AddMessage.PayloadEntryR\apayload\x12%\n" +
	"\x0estring_payload\x18\x03 \x01(\tR\rstringPayload\x12D\n" +
	"\bmetadata\x18\v \x03(\v2(.blipai.deckard.AddMessage.MetadataEntryR\bmetadata\x12\x14\n" +
	"\x05queue\x18\x04 \x01(\tR\x05queue\x12\x1a\n" +
	"\btimeless\x18\x06 \x01(\bR\btimeless\x12\x1f\n" +
	"\vttl_minutes\x18\a \x01(\x03R\n" +
	"ttlMinutes\x12 \n" +
	"\vdescription\x18\b \x01(\tR\vdescription\x12\x14\n" +
	"\x05score\x18\f \x01(\x01R\x05score\x1aP\n" +
	"\fPayloadEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12*\n" +
	"\x05value\x18\x02 \x01(\v2\x14.google.protobuf.AnyR\x05value:\x028\x01\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01J\x04\b\x05\x10\x06J\x04\b\x02\x10\x03J\x04\b\t\x10\n" +
	"\"W\n" +
	"\vAddResponse\x12#\n" +
	"\rcreated_count\x18\x01 \x01(\x03R\fcreatedCount\x12#\n" +
	"\rupdated_count\x18\x02 \x01(\x03R\fupdatedCount\"r\n" +
	"\x10EditQueueRequest\x12\x14\n" +
	"\x05queue\x18\x01 \x01(\tR\x05queue\x12H\n" +
	"\rconfiguration\x18\x02 \x01(\v2\".blipai.deckard.QueueConfigurationR\rconfiguration\"C\n" +
	"\x11EditQueueResponse\x12\x14\n" +
	"\x05queue\x18\x01 \x01(\tR\x05queue\x12\x18\n" +
	"\asuccess\x18\x02 \x01(\bR\asuccess\"7\n" +
	"\x12QueueConfiguration\x12!\n" +
	"\fmax_elements\x18\x01 \x01(\x03R\vmaxElements\"'\n" +
	"\x0fGetQueueRequest\x12\x14\n" +
	"\x05queue\x18\x01 \x01(\tR\x05queue\"r\n" +
	"\x10GetQueueResponse\x12\x14\n" +
	"\x05queue\x18\x01 \x01(\tR\x05queue\x12H\n" +
	"\rconfiguration\x18\x02 \x01(\v2\".blipai.deckard.QueueConfigurationR\rconfiguration\"\xea\x01\n" +
	"\n" +
	"AckRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05queue\x18\x02 \x01(\tR\x05queue\x12\x16\n" +
	"\x06reason\x18\x05 \x01(\tR\x06reason\x12)\n" +
	"\x0escore_subtract\x18\x03 \x01(\x01B\x02\x18\x01R\rscoreSubtract\x12\x1e\n" +
	"\n" +
	"breakpoint\x18\x04 \x01(\tR\n" +
	"breakpoint\x12\x17\n" +
	"\alock_ms\x18\x06 \x01(\x03R\x06lockMs\x12$\n" +
	"\rremoveMessage\x18\a \x01(\bR\rremoveMessage\x12\x14\n" +
	"\x05score\x18\n" +
	" \x01(\x01R\x05score\"r\n" +
	"\vAckResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12I\n" +
	"\x10removal_response\x18\x02 \x01(\v2\x1e.blipai.deckard.RemoveResponseR\x0fremovalResponse\"\x0e\n" +
	"\fFlushRequest\")\n" +
	"\rFlushResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess2\xcf\x05\n" +
	"\aDeckard\x12>\n" +
	"\x03Add\x12\x1a.blipai.deckard.AddRequest\x1a\x1b.blipai.deckard.AddResponse\x12A\n" +
	"\x04Pull\x12\x1b.blipai.deckard.PullRequest\x1a\x1c.blipai.deckard.PullResponse\x12>\n" +
	"\x03Ack\x12\x1a.blipai.deckard.AckRequest\x1a\x1b.blipai.deckard.AckResponse\x12?\n" +
	"\x04Nack\x12\x1a.blipai.deckard.AckRequest\x1a\x1b.blipai.deckard.AckResponse\x12D\n" +
	"\x05Count\x12\x1c.blipai.deckard.CountRequest\x1a\x1d.blipai.deckard.CountResponse\x12G\n" +
	"\x06Remove\x12\x1d.blipai.deckard.RemoveRequest\x1a\x1e.blipai.deckard.RemoveResponse\x12D\n" +
	"\x05Flush\x12\x1c.blipai.deckard.FlushRequest\x1a\x1d.blipai.deckard.FlushResponse\x12J\n" +
	"\aGetById\x12\x1e.blipai.deckard.GetByIdRequest\x1a\x1f.blipai.deckard.GetByIdResponse\x12P\n" +
	"\tEditQueue\x12 .blipai.deckard.EditQueueRequest\x1a!.blipai.deckard.EditQueueResponse\x12M\n" +
	"\bGetQueue\x12\x1f.blipai.deckard.GetQueueRequest\x1a .blipai.deckard.GetQueueResponseBA\n" +
	"\x0fai.blip.deckardP\x01Z\x1agithub.com/takenet/deckard\xaa\x02\x0fTakenet.Deckardb\x06proto3"

var (
	file_deckard_service_proto_rawDescOnce sync.Once
	file_deckard_service_proto_rawDescData []byte
)

func file_deckard_service_proto_rawDescGZIP() []byte {
	file_deckard_service_proto_rawDescOnce.Do(func() {
		file_deckard_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_deckard_service_proto_rawDesc), len(file_deckard_service_proto_rawDesc)))
	})
	return file_deckard_service_proto_rawDescData
}

var file_deckard_service_proto_msgTypes = make([]protoimpl.MessageInfo, 27)
var file_deckard_service_proto_goTypes = []any{
...
func file_deckard_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_deckard_service_proto_rawDesc), len(file_deckard_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   27,
			NumExtensions: 0,
			NumServices:   1,
