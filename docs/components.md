...
- Memory (default)
- MongoDB
  - Supported versions: `7.0` to `8.0` (we always run our integration tests against the `7.0` and the latest version)
...
- Memory (default)
- Redis
    - Supported versions: `5.0` to `8.2` (CI runs compatibility tests on `5.0.14` and tests on `8.2`)
